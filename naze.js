        ...
        switch (fileSha256 || command) {
            ...
            case 'deletesession': case 'delsession': {
                ...
                fs.readdir('./twenty', async function (err, files) {
                    ...
                    let teks = `مُكتَشَف ${filteredArray.length} Session file\n\n`
            ...
            case 'deletesampah': case 'delsampah': {
                ...
                fs.readdir('./database/sampah', async function (err, files) {
                    ...
                    let teks = `مُكتَشَف ${filteredArray.length} Sampah file\n\n`
                    if (filteredArray.length == 0) return m.reply(teks);
                    filteredArray.map(function (e, i) {
                        teks += (i + 1) + `. ${e}\n`
                    })
            ...
            case 'warn': case 'warning': {
                ...
                if (text || m.quoted) {
                    ...
                    if (!db.groups[m.chat].warn[numbersOnly]) {
                        ...
                        m.reply('Peringatan 1/4, سيتم طرده في أي وقت❗')
                    } else if (db.groups[m.chat].warn[numbersOnly] >= 3) {
                        await naze.groupParticipantsUpdate(m.chat, [numbersOnly], 'remove').catch((err) => m.reply('فشل!'))
                        delete db.groups[m.chat].warn[numbersOnly]
                    } else {
                        db.groups[m.chat].warn[numbersOnly] += 1
                        m.reply(`Peringatan ${db.groups[m.chat].warn[numbersOnly]}/4, سيتم طرده في أي وقت❗`)
                    }
                } else m.reply(`Contoh: ${prefix + command} 62xxx`)
            }
                break
            ...
            case 'ssweb': {
                if (!isPremium) return m.reply(mess.prem)
                if (!text) return m.reply(`Example: ${prefix + command} https://github.com/twenty010/naze-md`)
                try {
            ...
            case 'tinyurl': case 'shorturl': case 'shortlink': {
                if (!isLimit) return m.reply(mess.limit)
                if (!text || !isUrl(text)) return m.reply(`Example: ${prefix + command} https://github.com/twenty010/twenty`)
                try {
            ...
            case 'git': case 'gitclone': {
                if (!isLimit) return m.reply(mess.limit)
                if (!args[0]) return m.reply(`Example: ${prefix + command} https://github.com/twenty010/twenty`)
            ...
            // Quotes Menu
            case 'motivasi': {
                const hasil = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/motivasi.json');
                m.reply(pickRandom(hasil))
            }
                break
            case 'bijak': {
                const hasil = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/bijak.json');
                m.reply(pickRandom(hasil))
            }
                break
            case 'dare': {
                const hasil = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/dare.json');
                m.reply(pickRandom(hasil))
            }
                break
            case 'quotes': {
                const res = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/quotes.json');
                const hasil = pickRandom(res);
                m.reply(`_${hasil.quotes}_\n\n*- ${hasil.author}*`)
            }
                break
            case 'truth': {
                const hasil = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/truth.json');
                m.reply(`_${pickRandom(hasil)}_`)
            }
                break
            case 'renungan': {
                const hasil = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/renungan.json');
                m.reply('', {
                    contextInfo: {
                        forwardingScore: 10,
                        isForwarded: true,
                ...
                break
            case 'bucin': {
                const hasil = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/kata-kata/bucin.json');
                m.reply(pickRandom(hasil))
            }
                break
            ...
            case 'cekkhodam': {
                if (!text) return m.reply(`Example : ${prefix + command} nama lu`)
                try {
                    const res = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/random/cekkhodam.json');
                    const hasil = pickRandom(res);
            ...
            case 'tekateki': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tekateki.json');
            ...
            case 'tebaklirik': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tebaklirik.json');
                const hasil = pickRandom(soal);
            ...
            case 'tebakkata': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tebakkata.json');
                const hasil = pickRandom(soal);
            ...
            case 'family100': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/family100.json');
                const hasil = pickRandom(soal);
                let { key } = await m.reply(`🎮 Tebak Kata Berikut :\n\n${hasil.soal}\n\nWaktu : 5m\nHadiah *+3499*`)
                family100[m.chat] = {
                    soal: hasil.soal,
            ...
            case 'susunkata': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/susunkata.json');
                const hasil = pickRandom(soal);
            ...
            case 'tebakkimia': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tebakkimia.json');
                const hasil = pickRandom(soal);
            ...
            case 'caklontong': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/caklontong.json');
                const hasil = pickRandom(soal);
            ...
            case 'tebaknegara': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tebaknegara.json');
                const hasil = pickRandom(soal);
            ...
            case 'tebakgambar': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tebakgambar.json');
                const hasil = pickRandom(soal);
            ...
            case 'tebakbendera': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/games/tebakbendera.json');
                const hasil = pickRandom(soal);
            ...
            case 'tebakangka': case 'butawarna': case 'colorblind': {
                ...
                const soal = await fetchJson('https://raw.githubusercontent.com/twenty/database/refs/heads/master/random/color_blind.json');
                const hasil = pickRandom(soal);
...
╰─┬────❍
╭─┴─❍「 *معلومات البوت* 」❍
├ *Nama Bot* : ${db?.set?.[botNumber]?.botname || 'TWENTY BOT'}
